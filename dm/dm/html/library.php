        ...
        <div class="top_bar">
            ...
            <div class="topbar_lv2">
                <form class="srcbar_box" method="post" action="">
                    <button class="src_clk" name="search">Search</button>
                    <input class="search_bar" placeholder="search keywords" type="text" name="searchs">
                </form>
            </div>
            <!-- <input type="text"> -->
...
?>     
 ...
 <?php include'../connect.php';
	...
	$selr="SELECT * FROM books WHERE name like '%{$search}%'";
