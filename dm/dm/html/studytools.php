...
?>     
        ...
        <div class="flex_main">
            <div class="all_cards">
                <!---<div class="card">
                    <img class="studytools_icons" src="../images/course_info.svg" alt="">      
                    <a href="../html/course_info.php">
                        <div class="card_text">
                            <h3>COURSE INFO</h3>
                            <br>
                            <p>See all the departments, courses<br/> 
                            and Preciosities</p>
                        </div>
                    </a>
                </div>--->
                <div class="card">
                    <img class="studytools_icons" src="../images/note_book.svg" alt="">      
                    <a href="../html/notebook.php">
                        <div class="card_text">
                            <h3>NOTEBOOK</h3>
                            <br>
                            <p>Take notes onlines</p>
                        </div>
                    </a>
                </div>
                <div class="card">
                    <img class="studytools_icons" src="../images/note_web.svg" alt="">      
                    <a href="../html/notweb.php">
                        <div class="card_text">
                            <h3>NOTE WEB</h3>
                            <br>
                            <p>Save your notes online</p>
                        </div>
                    </a>
                </div>
                <div class="card">
                    <img class="studytools_icons" src="../images/gpa_calc.svg" alt="">      
                    <a href="../html/cgpa_calc.php">
                        <div class="card_text">
                            <h3>CGPA CALCULATOR</h3>
                            <br>
                            <p>Calculate Your Cumulative grade point average (CGPA)</p>
                        </div>
                    </a>
                </div>
                
                <div class="card">
                    <img class="studytools_icons" src="../images/library.svg" alt="">      
                    <a href="../html/library.php">
                        <div class="card_text">
                            <h3>LIBRARY</h3>
                            <br>
                            <p>Get access to numerous study materials</p>
                        </div>
                    </a>
                </div>
                ...
                <div class="card">
                    ...
                    <a href="../html/cbttest.php">
                        <div class="card_text">
                            <h3>CBT Test</h3>
                            <br>
                            <p>Test yourself with several past questions</p>
                        </div>
                    </a>
                </div>
                ...
                <div class="card">
                    ...
                    <a href="#">
                        <div class="card_text">
                            <h3>Resource team</h3>
                            <br>
                            <p>Perform tasks and get special bonus</p>
                        </div>
                    </a>
                </div>
